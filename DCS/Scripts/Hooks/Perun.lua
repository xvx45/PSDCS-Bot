...
Perun.Instance = 3														-- (int) Id number of instance (if multiple DCS instances are to run at the same PC)
...
Perun.MOTD_L1 = "Bienvenue pilote du Fail"						-- (string) Message send to players connecting the server - Line 1
Perun.MOTD_L2 = "Bisous Quentin"		-- (string) Message send to players connecting the server - Line 2
